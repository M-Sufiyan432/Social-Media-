...
const ForgotPassword = () => {
  ...
  const handleStep3 = async () => {
    ...
    try {
      if (newPassword != confirmNewPassword) {
        return console.log("The password are not matched ");
      }
      const res = await axios.post(
        `${serverURL}/api/auth/resetPassoword`,
  ...
  return (
    ...
    >
      {step == 1 && (
        <div
          className="w-[90%] max-w-[500px] h-[500px] bg-white rounded-2xl flex justify-center
      items-center  flex-col border-[#1a1f23]"
        ...
        cursor-pointer rounded-2xl mt-[30px] "
            ...
            onClick={handleStep1}
          >
            {loading ? <ClipLoader size={30} color="white" /> : `Sent to Email`}
